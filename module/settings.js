...
export const registerSettings = function () {
  ...
  game.settings.register('moshru', 'firstEdition', {
    name: "1e Rules",
    ...
    onChange: value => {
      ...
      if (game.settings.get('moshru','useCalm') === false) {
  ...
  game.settings.register('moshru', 'macroTarget', {
    name: "Macro Target",
  ...
  game.settings.register('moshru', 'critDamage', {
  ...
  game.settings.register('moshru', 'damageDiceTheme', {
  ...
  game.settings.register('moshru', 'panicDieTheme', {
  ...
  game.settings.register('moshru', 'hideWeight', {
    name: "Hide 0e Weight",
  ...
  game.settings.register('moshru', 'useCalm', {
    name: "Use Calm?",
      ...
      //if value is now false
        ...
        actorList.forEach(function(actor){ 
          ...
          if (actor.type === 'character') {
            ...
            if (game.settings.get('moshru','firstEdition')) {
              //set max stress to 20
              actor.update({'system.other.stress.max': 20});
              maxEnd = 20;
            } else {
  ...
  game.settings.register('moshru', 'androidPanic', {
  ...
  game.settings.register('moshru', 'autoStress', {
  ...
  game.settings.registerMenu('moshru', 'rolltableSelector', {
  ...
  game.settings.register('moshru', 'table0ePanicStressNormal', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table0ePanicStressAndroid', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table0ePanicCalmNormal', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table0ePanicCalmAndroid', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table1ePanicStressNormal', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table1ePanicStressAndroid', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table1ePanicCalmNormal', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table1ePanicCalmAndroid', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table1eWoundBluntForce', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table1eWoundBleeding', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table1eWoundGunshot', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table1eWoundFireExplosives', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table1eWoundGoreMassive', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table0eDeath', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table1eDeath', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table1eDistressSignal', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table1eMegadamageEffects', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table1eMaintenance', {
    scope: 'world',
    config: false,
    type: String,
  ...
  game.settings.register('moshru', 'table1eBankruptcy', {
    scope: 'world',
    config: false,
    type: String,
